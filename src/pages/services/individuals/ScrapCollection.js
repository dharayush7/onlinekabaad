...
const ScrapCollection = () => {
      ...
      <div className="row pt-lg-12" b-c9s2b9qmjt="">
        <div className="col-lg-6 col-12 ps-lg-12" b-c9s2b9qmjt="">
          ...
          <div className="body-lg mt-lg-7 mt-4" b-c9s2b9qmjt="">
            In this evolving technological world, let your kabaad find a
            kabadiwala, ONLINE!
          </div>
          <div
  ...
  >
    ...
    <div className="text-center pb-lg-11 d-none d-lg-block" b-c9s2b9qmjt="">
      <img
    ...
    <div className="container row p-0 pb-14" b-c9s2b9qmjt="">
      <div className="col-lg-4 col-12 pe-lg-11 mt-10 mt-lg-0" b-c9s2b9qmjt="">
        <h4 className="fg-success-2" b-c9s2b9qmjt="">
          Step 1
        </h4>
        <div className="d-none d-lg-block" b-c9s2b9qmjt="">
          ...
          >
            ...
            // playsInline
              // loop="200"
              poster='../../../assets/images/individual/choose-material.webp'
              className="mw-100 "
              b-c9s2b9qmjt=""
            >
              <source
                // src="images/individual/check.m4v"
                 src="../../../assets/images/individual/check.m4v"
                type="video/m4v"
                b-c9s2b9qmjt=""
              />
              <source
                src="../../../assets/images/individual/check.mp4"
                type="video/mp4"
                b-c9s2b9qmjt=""
              />
            </video>
          ...
          <div className="body-lg fg-inverse-1 mt-lg-6 mt-3" b-c9s2b9qmjt="">
        ...
        <div className="d-lg-none row" b-c9s2b9qmjt="">
          <div className="col-6" b-c9s2b9qmjt="">
            ...
            >
              <video
                loop=""
                // poster="images/individual/choose-material.webp"
                poster="../../../assets/images/individual/choose-material.webp"
              ...
              >
                ...
                />
                <source
                  // src="images/individual/check.mp4"
                  src="../../../assets/images/individual/check.m4"
                  type="video/mp4"
                  b-c9s2b9qmjt=""
                />
              </video>
          ...
          <div className="col-6 p-0" b-c9s2b9qmjt="">
            ...
            <div className="body-lg fg-inverse-1 mt-lg-6 mt-3" b-c9s2b9qmjt="">
              Select your Scrap that you want to sell out of a 40+ scrap
              category options.
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-12 pe-lg-11 mt-10 mt-lg-0" b-c9s2b9qmjt="">
        ...
        <div className="d-none d-lg-block" b-c9s2b9qmjt="">
          ...
          >
            <video
              loop=""
              poster="images/individual/schedule-pickup.webp"
              className="mw-100 video-play"
              b-c9s2b9qmjt=""
            >
              <source
                src="images/individual/calender.m4v"
                type="video/m4v"
                b-c9s2b9qmjt=""
              />
              <source
                src="images/individual/calender.mp4"
                type="video/mp4"
                b-c9s2b9qmjt=""
              />
            </video>
        ...
        <div className="d-lg-none row" b-c9s2b9qmjt="">
          ...
          <div className="col-6 p-0" b-c9s2b9qmjt="">
            ...
            <div className="body-lg fg-inverse-1 mt-lg-6 mt-3" b-c9s2b9qmjt="">
              Select your date and add the location from where the scrap will be
              picked up.
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-12 pe-lg-11 mt-10 mt-lg-0" b-c9s2b9qmjt="">
        ...
        <div className="d-none d-lg-block" b-c9s2b9qmjt="">
          ...
          >
            <video
              loop=""
              poster="images/individual/recieve-payment.webp"
              className="mw-100 video-play"
              b-c9s2b9qmjt=""
            >
              <source
                src="images/individual/billing.m4v"
                type="video/m4v"
                b-c9s2b9qmjt=""
              />
              <source
                src="images/individual/billing.mp4"
                type="video/mp4"
                b-c9s2b9qmjt=""
              />
            </video>
          ...
          <div b-c9s2b9qmjt="">
            ...
            <div className="body-lg fg-inverse-1 mt-lg-6 mt-3" b-c9s2b9qmjt="">
              Recieve payment in any one of the three payment modes via cash or
              UPI or IMPS.
            </div>
          </div>
        </div>
  ...
  >
    ...
    >
      ...
      <div className="body-lg mt-lg-7 mt-5 mx-lg-14" b-c9s2b9qmjt="">
        Raise a request from the comfort of your home with The Kabadiwala’s easy
      ...
      >
        ...
        >
          <video
            loop=""
            poster="images/individual/request.webp"
            className="mw-100 video-play"
            style={{ height: "35vh" }}
            b-c9s2b9qmjt=""
          >
            <source
              src="images/individual/location.m4v"
              type="video/m4v"
              b-c9s2b9qmjt=""
            />
            <source
              src="images/individual/location.mp4"
              type="video/mp4"
              b-c9s2b9qmjt=""
            />
          </video>
    ...
    >
      ...
      >
        ...
        >
          <video
            loop=""
            poster="images/individual/recycle.webp"
            className="mw-100 video-play"
            style={{ height: "35vh" }}
            b-c9s2b9qmjt=""
          >
            <source
              src="images/individual/recykle.m4v"
              type="video/m4v"
              b-c9s2b9qmjt=""
            />
            <source
              src="images/individual/recycle.mp4"
              type="video/mp4"
              b-c9s2b9qmjt=""
            />
          </video>
    ...
    >
      ...
      >
        ...
        >
          <video
            loop=""
            poster="images/individual/reward.webp"
            className="mw-100 video-play"
            style={{ height: "35vh" }}
            b-c9s2b9qmjt=""
          >
            <source
              src="images/individual/rewards.m4v"
              type="video/m4v"
              b-c9s2b9qmjt=""
            />
            <source
              src="images/individual/rewards.mp4"
              type="video/mp4"
              b-c9s2b9qmjt=""
            />
          </video>
    ...
    <div className="row align-items-center" b-c9s2b9qmjt="">
      ...
      <div className="col-lg-7 ps-lg-8 col-12" b-c9s2b9qmjt="">
        ...
        <div className="body-lg pt-lg-5 pt-2" b-c9s2b9qmjt="">
          ...
          the natural resources you saved from over-exploitation or the units of
          energy you preserved for a sustainable future.
        </div>
        <div className="d-flex pt-6 text-center" b-c9s2b9qmjt="">
          <div className="pe-lg-10" b-c9s2b9qmjt="">
            <img
              src="images/individual/water.png"
              alt="water"
              b-c9s2b9qmjt=""
            />
            <div className="pt-lg-6 pt-4 label-lg" b-c9s2b9qmjt="">
              Water
            </div>
          </div>
          <div className="pe-lg-10" b-c9s2b9qmjt="">
            <img
              src="images/individual/trees.png"
              alt="trees"
              b-c9s2b9qmjt=""
            />
            <div className="pt-lg-6 pt-4 label-lg" b-c9s2b9qmjt="">
          ...
          <div className="pe-lg-10" b-c9s2b9qmjt="">
            <img
              src="images/individual/electricity.png"
              alt="electricity"
              b-c9s2b9qmjt=""
            />
            <div className="pt-lg-6 pt-4 label-lg" b-c9s2b9qmjt="">
          ...
          <div className="pe-lg-10" b-c9s2b9qmjt="">
            <img src="images/individual/oil.png" alt="oil" b-c9s2b9qmjt="" />
            <div className="pt-lg-6 pt-4 label-lg" b-c9s2b9qmjt="">
              Oil
            </div>
          </div>
  ...
  >
    <div className="row" b-c9s2b9qmjt="">
      <div className="col-lg-6 col-12" b-c9s2b9qmjt="">
        ...
        <div className="body-lg mt-7 mb-8 mt-lg-5 fg-inverse-1" b-c9s2b9qmjt="">
          Let go of your age old unfit motor that doesn't serve its purpose
          neither to you nor to the environment &amp; help bring circularity in
              ...
              <div className="card-body" b-c9s2b9qmjt="">
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-lg-3 p-6" b-c9s2b9qmjt="">
                    <div className="d-flex align-items-center" b-c9s2b9qmjt="">
                      <h4 className="fg-inverse-1 flex-grow-1" b-c9s2b9qmjt="">
                        Why
                      </h4>
                      <div
                        className="d-flex flex-row px-7 py-5 align-items-center justify-content-center title-lg rounded-circle"
                        style={{ backgroundColor: "#003066" }}
                        b-c9s2b9qmjt=""
                      >
                        1
                      </div>
                    </div>
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      A vehicle as old as 10 to 15 years becomes unfit to drive
                      on roads due to its decreased efficiency and increased
                      carbon emissions, making it prone to road accidents,
                      requires high maintenance, and causes extensive harm to
                      the environment.
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body" b-c9s2b9qmjt="">
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-lg-3 p-6" b-c9s2b9qmjt="">
                    ...
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      Adhering to the Vehicle Scrappage Policy of 2021, the
                      right disposal of the scrapped vehicle is streamlined,
                      thus helping to establish a circular economy in the
                      automobile sector. While you enjoy perks like no
                      registration fee on your new purchase &amp; few road taxes
                      waiver.
                    </div>
                  </div>
                </div>
                ...
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-lg-3 p-6" b-c9s2b9qmjt="">
                    ...
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      ...
                      Kabadiwala provides solutions for its right disposal while
                      giving fair value against it. We also issue a vehicle
                      scrapping certificate so that you can avail the benefits
                      stated under the Vehicle Scrappage Policy 2021.
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div className="row align-items-center" b-c9s2b9qmjt="">
      <div className="col-lg-6 col-12 order-lg-1 order-2" b-c9s2b9qmjt="">
        ...
        <div className="body-lg mt-5 mt-lg-7 pe-lg-8" b-c9s2b9qmjt="">
          Did you know? More than half of our household waste is kitchen waste
          and the rest consists of dry &amp; hazardous waste. Each waste type
          has to be segregated at source to enable its right disposal so that a
          circular economy can be formed. Click the button below to know about
          your waste.
        </div>
      </div>
      <div
    ...
    <div className="row" b-c9s2b9qmjt="">
      <div className="col-lg-7 col-12" b-c9s2b9qmjt="">
        ...
        <div className="body-lg mt-7 mb-8 me-lg-14" b-c9s2b9qmjt="">
          With our zero waste management services we help your society to turn
          zero waste by incorporating zero waste practices within its residents
          &amp; stakeholders.
        </div>
      </div>
    </div>
              ...
              <div className="card-body" b-c9s2b9qmjt="">
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-6 p-lg-3" b-c9s2b9qmjt="">
                    ...
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      To promote the circular flow of materials to reduce the
              ...
              <div className="card-body" b-c9s2b9qmjt="">
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-6 p-lg-3" b-c9s2b9qmjt="">
                    ...
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      Establishing circular economy benefits in reducing climate
                      impact, conserving resources and minimizing pollution.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="d-flex flex-column" b-c9s2b9qmjt="">
                  <div className="p-6 p-lg-3" b-c9s2b9qmjt="">
                    ...
                    <div className="body-lg mt-3" b-c9s2b9qmjt="">
                      ...
                      reducing, reusing, and recycling waste to become a zero
                      waste society.
                    </div>
                  </div>
                </div>
    ...
    <div className="row align-items-center" b-c9s2b9qmjt="">
      ...
      >
        ...
        <div className="body-lg pt-lg-7 pe-lg-6" b-c9s2b9qmjt="">
          After you sell your dry recyclable waste to us, they are collected in
          The Kabadiwala's facility to be segregated, baled and then transported
          to the authorized recyclers to take new forms so as to enter back into
          the economy to achieve circularity.
        </div>
      </div>
          ...
          <div className="card card-media-bg">
            ...
            <div className="card-body position-absolute top-50 start-50 translate-n50">
              <svg
                ...
                b-c9s2b9qmjt=""
              >
                <circle cx={31} cy={31} r={31} fill="#44B31F" b-c9s2b9qmjt="" />
                <path
          ...
          <div className="d-block mx-5" style={{ maxWidth: "20rem" }}>
            <div className="card card-media-top rounded-5">
              ...
              <div className="card-body">
                <div className="d-flex flex-column" style={{ height: "15rem" }}>
                  ...
                  <div className="fg-default-2 pb-5 body-md flex-fill overflow-hidden">
                    The Kabadiwala collaborated with TetraPak India (World’s
                    Leading Beverage Carton Manufacturer) to increase the
                    collection of used beverage cartons (UBC’s) for recycling
              ...
              <div className="media">
                <img
                  // src="images/landing/our-initiative/mattress-circular-economy.webp"
                    src="../../../assets/images/landing/our-initiative/mattress-circular-economy.webp"
              ...
              <div className="card-body">
                <div className="d-flex flex-column" style={{ height: "15rem" }}>
                  ...
                  <div className="fg-default-2 pb-5 body-md flex-fill overflow-hidden">
                    ...
                    ‘Feko Nahi Recycle Karo’. The objective is to encourage the
                    community to practise sustainable disposal of Mattress.
                  </div>
                  <div className="pt-4">
            ...
            <div className="card card-media-top rounded-5">
              <div className="media">
                <img
                  ...
                  src="../../../assets/images/landing/our-initiative/tree-plantation-initiative.webp"
              ...
              <div className="card-body">
                <div className="d-flex flex-column" style={{ height: "15rem" }}>
                  ...
                  <div className="fg-default-2 pb-5 body-md flex-fill overflow-hidden">
                    Since the last two years, The Kabadiwala has been following
                    a tradition of planting trees on the occasion of Mahatma
                    Gandhi's Birthday. In which, our customers also take part in
                    our mission to turn Bhopal greener.
                  </div>
                  <div className="pt-4">
            ...
            <div className="card card-media-top rounded-5">
              <div className="media">
                <img
                  ...
                  src="../../../assets/images/landing/our-initiative/kitab-ghar.webp"
              ...
              <div className="card-body">
                <div className="d-flex flex-column" style={{ height: "15rem" }}>
                  <span className="title-lg fg-default-1 pb-3">Kitab Ghar</span>
                  <div className="fg-default-2 pb-5 body-md flex-fill overflow-hidden">
                    Kitab Ghar initiative is a combined effort of The Kabadiwala
                    &amp; Bhopal Municipal Corporation that aims at providing
                    second hand books to the underprivileged children by
                    acquiring them from the people who no longer need them.
                  </div>
                  <div className="pt-4">
                    <a
            ...
            <div className="card card-media-top rounded-5">
              ...
              <div className="card-body">
                <div className="d-flex flex-column" style={{ height: "15rem" }}>
                  ...
                  <div className="fg-default-2 pb-5 body-md flex-fill overflow-hidden">
                    On International Plastic Bag Free day, The Kabadiwala placed
                    a wall made up of polythene bags, wrappers, and plastic
                    packing material, in a busy market area to block people’s
                    way. Click below to learn why we did this.
                  </div>
                  <div className="pt-4">
                    <a
            ...
            <div className="card-body">
              ...
              >
                ...
                <div className="body-lg mt-8 flex-grow-1" b-c9s2b9qmjt="">
                  The service is amazing. The experience is like an e commerce
                  platform and the best part is that you get paid for selling
                  your stuff. The app is very smooth. Highly recommended.
                </div>
          ...
          <div className="card card-media-top pt-6 px-7">
            <div className="card-body">
              ...
              >
                ...
                <div className="body-lg mt-8 flex-grow-1" b-c9s2b9qmjt="">
                  Very well organised and systematic process, impressive work. I
                  got instant payment for my waste material. behaviour of pickup
                  boys was very humble.
                </div>
                <h6 className="mb-5" b-c9s2b9qmjt="">
                  Arpit Gupta
                </h6>
          ...
          <div className="card card-media-top pt-6 px-7">
            <div className="card-body">
              ...
              >
                ...
                <div className="body-lg mt-8 flex-grow-1" b-c9s2b9qmjt="">
                  Superb, Fast &amp; Fantastic service. Sold kabad within 24
                  hours of booking an appointment. Good work guys keep it up 👌
                </div>
                <h6 className="mb-5" b-c9s2b9qmjt="">
                  Sunny Singh
                </h6>
          ...
          <div className="card card-media-top pt-6 px-7">
            <div className="card-body">
              ...
              >
                ...
                <div className="body-lg mt-8 flex-grow-1" b-c9s2b9qmjt="">
                  Awesome platform. I gave 25 kg kabad and they gave me Rs. 250.
                  Digital weighing machine and transparent charges... Loved it
                  😍😍😍
                </div>
                <h6 className="mb-5" b-c9s2b9qmjt="">
                  Apratim Chatterjee
          ...
          <div className="card card-media-top pt-6 px-7">
            <div className="card-body">
              ...
              >
                ...
                <div className="body-lg mt-8 flex-grow-1" b-c9s2b9qmjt="">
                  Very Good App. Its so easy to sell Scrap now with this app. I
                  did a appointment and the pick up guy came the same day as
                  scheduled. The Pick up people were polite and professional
                  towards us. And in just a few time my useless scrap turned
                  into Countable money!
                </div>
                <h6 className="mb-5" b-c9s2b9qmjt="">
                  Khan
                </h6>
