...
<style>
  ...
  <Card className=" rounded-start-6 h-100 " style={{width:"80%"}}>
    <Card.Body className="rounded-6" style={{backgroundColor:"#0dc02b"}}>
      ...
      <div className="mt-5 ">
        <div className="d-flex align-items-center mb-4">
          ...
          <a href="tel: +918790331428" className="title-lg  not-hover fg-inverse-1">
          +91 8790331428
          </a>
        </div>
        <div className="d-flex align-items-center mb-4">
          <i className="bi bi-envelope-fill text-white me-3"></i>
          <a href="mailto:contact@onlinekabaad.com" className="title-lg  not-hover fg-inverse-1">
