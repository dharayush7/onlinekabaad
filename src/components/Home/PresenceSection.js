      ...
      <Container className="h-100 d-flex flex-column justify-content-center">
        ...
        <Row className="align-items-center">
          <Col xs={12} lg={6} className="order-lg-1 order-2">
            ...
            <div className="py-6 body-lg text-center  text-lg-start" style={{color:"var(--fg-inverse-0)"}}>
             <p className='text-default' style={{color:"var(--fg-default-0)"}}>
               The Kabadiwala has established its services in
              <span style={{color: "#009c1a"}}> 5 major cities of India </span>
            ...
            <div className="d-flex flex-wrap  align-items-center justify-content-center  justify-content-lg-start gap-3">
              {cities.map((city, index) => (
               ...
               city.status==='active' ?
               <div key={index} className={`label-md ${city.status === 'active  ' ? 'bgsky py-5 px-6 '  : 'citybg'}  rounded-3  border border-radius-3`} style={{width:"auto"}}>
             ...
             <div class=" container-bg-warning-2 rounded-3 text-center " >
              <h6 class="label-md container-bg-2 rounded-3 py-2 px-6 m-0 "> {city.name}</h6>
             <div class="body-sm fg-warning-1 px-6 " >coming soon</div></div>
